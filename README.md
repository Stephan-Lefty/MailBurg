...
**Fassung 1.7.2, im Alltag im Einsatz.** Archivformat, IMAP-Abruf, Suche samt
...
Maildir-Verzeichnissen (so legt **Evolution** seine lokalen Ordner ab),
MBOX-Dateien und **Ordnern voller `.eml`-Dateien** – auch verschachtelt, und
