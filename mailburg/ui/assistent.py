...
class WillkommenSeite(QWizardPage):
    def __init__(self) -> None:
        ...
        text = QLabel(
            ...
            "nie mehr ändern.</p>"
            "<p><b>Was nicht passiert:</b> Ihre Post geht nirgendwo hin, wo "
            "Sie sie nicht hingelegt haben. MailBurg schickt nichts zu uns "
            "oder zu einem anderen Anbieter und meldet auch nicht, dass Sie "
            "es benutzen. Die einzigen Verbindungen, die es aufbaut, gehen zu "
            "Ihren eigenen Mailservern – um die Post abzuholen.</p>"
