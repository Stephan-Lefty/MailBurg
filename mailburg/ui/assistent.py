...
class WillkommenSeite(QWizardPage):
    def __init__(self) -> None:
        ...
        text = QLabel(
            ...
            "irgendwo geführt würden. Es wird nicht gezählt, wie oft Sie das "
            "Programm öffnen oder wonach Sie suchen; es werden keine "
            "Fehlerberichte verschickt, und es fragt auch nicht nach, ob es "
            "eine neuere Fassung gibt.</p>"
            "<p>Sie müssen uns das nicht glauben: Der gesamte Quelltext ist "
            "offen einsehbar, und wer nachsehen möchte, was das Programm tut, "
            "kann es tun.</p>"
